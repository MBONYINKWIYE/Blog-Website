      ...
      <div className='flex flex-col items-center justify-center px-6 py-8 mt-[50px] mb-[50px] mx-auto md:h-screen lg:py-0'>
        ...
        <div className='w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 '>
          <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
            ...
            {errMsg && <p className='text-sm font-semibold text-red-600'>{errMsg}</p>}
            ...
            <form onSubmit={handleSubmit} className='space-y-4 md:space-y-6'>
              ...
              <button
                type='submit'
                className='w-full text-black bg-primary-600 hover:bg-purple-200 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center '
              >
                Sign in
              </button>
